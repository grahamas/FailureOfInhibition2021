"""
    Produces figure titled 
        "Excitation of inhibitory cells (AIE ) nonlinearly 
        modulates seizure susceptibility and rescuability."
    (Fig. 5 as of 2023 Nov 1; runtime 650ms)
"""
...
function plot_nullclines_differing_balanced_state(;
    ...
    @info "Making $(plotsdir(plots_subdir))"
    ...
    @info "Constructing prototype..."
    prototype = blocking_prototype(; mods..., higher_aie...)
    @info "Getting nullcline parameters..."
    higher_aie_nullcline_params = get_nullcline_params(prototype)
    
    @info "Entering plotting function..."
    ...
    lower_aie_prototype = blocking_prototype(; mods..., lower_aie...)
    lower_aie_nullcline_params = get_nullcline_params(lower_aie_prototype)
